...
class DefaultApi
{
    ...
    protected function removeObitRequest($obit_did)
    {
        ...
        $resourcePath = '/obits/{obit_did}/remove';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     */
    public function searchObits($usn = null, $owner_did = null, $offset = 0, $limit = 0)
    {
        list($response) = $this->searchObitsWithHttpInfo($usn, $owner_did, $offset, $limit);
        return $response;
    }
     ...
     */
    public function searchObitsWithHttpInfo($usn = null, $owner_did = null, $offset = 0, $limit = 0)
    {
        $request = $this->searchObitsRequest($usn, $owner_did, $offset, $limit);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchObitsAsync($usn = null, $owner_did = null, $offset = 0, $limit = 0)
    {
        return $this->searchObitsAsyncWithHttpInfo($usn, $owner_did, $offset, $limit)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchObitsAsyncWithHttpInfo($usn = null, $owner_did = null, $offset = 0, $limit = 0)
    {
        $returnType = '\Obada\Client\Model\InlineResponse200';
        $request = $this->searchObitsRequest($usn, $owner_did, $offset, $limit);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function searchObitsRequest($usn = null, $owner_did = null, $offset = 0, $limit = 0)
    {
        if ($offset !== null && $offset < 0) {
            throw new \InvalidArgumentException('invalid value for "$offset" when calling DefaultApi.searchObits, must be bigger than or equal to 0.');
        }

        if ($limit !== null && $limit > 100) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling DefaultApi.searchObits, must be smaller than or equal to 100.');
        }
        if ($limit !== null && $limit < 0) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling DefaultApi.searchObits, must be bigger than or equal to 0.');
        }
