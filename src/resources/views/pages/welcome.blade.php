    ...
    <div class="main">
        <div class="container">
            <section class="py-5 my-5">
                ...
                <div class="row pt-5">
                    <div class="col-12">
                        <h2>A simple "inventory manager" to demonstrate</h2>
                        ...
                        <h2 class="pt-5">A "reference design" to assist with implementation, showing how the following components are used:</h2>
                        <ul class="bullet-list">
                            <li>
                        ...
                        <h2 class="pt-5">
                            Other OBADA sites and tools
                        </h2>
                        <ul class="bullet-list">
                            <li>
                                OBADA Gateway Server & Tools - to assist with understanding and for test and debug purposes.
                                <ul class="bullet-list">
                                    <li><b><a href="https://gateway.obada.io/explorer/">Blockchain Explorer<a/></b></li>
